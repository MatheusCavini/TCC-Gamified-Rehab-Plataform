...
static const _SetString_Request_type_support_symbol_names_t _SetString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hal_interfaces, srv, SetString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hal_interfaces, srv, SetString_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hal_interfaces, srv, SetString_Request)() {
  return &::hal_interfaces::srv::rosidl_typesupport_c::SetString_Request_message_type_support_handle;
}
...
static const _SetString_Response_type_support_symbol_names_t _SetString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hal_interfaces, srv, SetString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hal_interfaces, srv, SetString_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, hal_interfaces, srv, SetString_Response)() {
  return &::hal_interfaces::srv::rosidl_typesupport_c::SetString_Response_message_type_support_handle;
}
...
static const _SetString_type_support_symbol_names_t _SetString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hal_interfaces, srv, SetString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, hal_interfaces, srv, SetString)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, hal_interfaces, srv, SetString)() {
  return &::hal_interfaces::srv::rosidl_typesupport_c::SetString_service_type_support_handle;
}
